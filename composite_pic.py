...
from process_foreground_pic import process_foreground_pic
from split_video_to_images import split_video_to_images
from supply_pic import supply_pic
from generate_random_pos import generate_random_pos
